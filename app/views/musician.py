...
def get_musician():
    ...
    musician_info = db.session.query(Musician.Name, Musician.Birthday, Musician.Height, Musician.MainAchievements, Musician.RepresentativeWorks).filter(Musician.Name == name).first()
    data = {
